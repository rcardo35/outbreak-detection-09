            ...
            <div class="single-popular-carusel col-lg-6 col-md-7">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        <i class="fa fa-check" style="color: green" aria-hidden="true"></i> Referral not required<br>
                        <i class="fa fa-check" style="color: green" aria-hidden="true"></i> Testing for all patients <br>
                        <i class="fa fa-phone info" style="color: #31708f" aria-hidden="true"></i> Call: 777-777-7777
                    </p>
                </div>
            </div>
            <div class="single-popular-carusel col-lg-6 col-md-7">
                ...
                <div class="details">
                    ...
                    <p>
                        ...
                        <i class="fa fa-exclamation" style="color: #CC0000" aria-hidden="true"></i> &nbsp;&nbsp;Appointment required<br>
                        <i class="fa fa-check" style="color: green" aria-hidden="true"></i> Referral not required<br>
                        <i class="fa fa-exclamation" style="color: #CC0000" aria-hidden="true"></i> &nbsp;&nbsp;Tests limited to certain patients<br>
                        <i class="fa fa-phone info" style="color: #31708f" aria-hidden="true"></i> &nbsp;Call: 777-777-7777
                    </p>
                </div>
            </div>
            ...
            <div class="single-popular-carusel col-lg-6 col-md-6">
                ...
                <div class="details">
                    ...
                    <p>
                        <i class="fa fa-map-marker" aria-hidden="true"></i> Bloomington, IN<br>
                        <i class="fa fa-exclamation" style="color: #CC0000" aria-hidden="true"></i> &nbsp;&nbsp;Appointment required<br>
                        <i class="fa fa-exclamation" style="color: #CC0000" aria-hidden="true"></i> Referral required<br>
                        <i class="fa fa-exclamation" style="color: #CC0000" aria-hidden="true"></i> &nbsp;&nbsp;Tests limited to certain patients<br>
                        <i class="fa fa-check" style="color: green" aria-hidden="true"></i> Drive-through<br>
                        <i class="fa fa-phone info" style="color: #31708f" aria-hidden="true"></i> &nbsp;Call: 777-777-7777
                    </p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-6 search-course-left">
                <h1 class="text-white">
                    Can't find one place near you?
                </h1>
                <p style="font-size: 16px">
                    Please enter your zip code to find your nearest testing center.
                </p>
            ...
            <div class="col-lg-4 col-md-6 search-course-right section-gap">
                <form class="form-wrap" action="">
                    <h4 class="text-white pb-20 text-center mb-30">Search for COVID-19 Testing Center</h4>
                    <input type="text" class="form-control" name="zipcode" placeholder="Your Zipcode">
