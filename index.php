            ...
            <div class="active-popular-carusel">
                <div class="single-popular-carusel">
                    ...
                    <div class="details">
                        ...
                        <p>
                            When television was young, there was a hugely popular show based on the still popular fictional character
                        </p>
                    </div>
                </div>
                <div class="single-popular-carusel">
                    ...
                    <div class="details">
                        ...
                        <p>
                            When television was young, there was a hugely popular show based on the still popular fictional characters
                        </p>
                    </div>
                </div>
                <div class="single-popular-carusel">
            ...
            <div class="active-upcoming-event-carusel">
                <div class="single-carusel row align-items-center">
                    <div class="col-12 col-md-6 thumb">
                        <img class="img-fluid" src="assets/img/e1.jpg" alt="">
                    </div>
                ...
                <div class="single-carusel row align-items-center">
                    <div class="col-12 col-md-6 thumb">
                        <img class="img-fluid" src="assets/img/e2.jpg" alt="">
                    </div>
                    <div class="detials col-12 col-md-6">
                        <p>25th February, 2018</p>
                        <a href="#"><h4>The Universe Through
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="wrap">
                ...
                <p>
                    There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s exciting to think about setting up your own viewing station whether that
                    is on the deck.
                </p>
